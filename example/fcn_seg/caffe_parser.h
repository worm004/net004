...
private:
	...
	void write_net_dconv(const std::string& layer_name, const caffe::LayerParameter& param, std::ofstream& ofile);
	void write_net_crop(const std::string& layer_name, const caffe::LayerParameter& param, const std::vector<std::string>& names, std::ofstream& ofile);
