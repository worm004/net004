...
void test_cifar10(){
	...
	ls.add_conv("conv0",{32,5,1,2},1,"relu");
	ls.add_pool("maxpool0",{3,2,0},"max");
	ls.add_conv("conv1",{32,5,1,2},1,"relu");
	ls.add_pool("maxpool1",{3,2,0},"max");
	ls.add_conv("conv2",{64,5,1,2},1,"relu");
...
void test_gnet_v1(){
	...
	ls.add_pool("maxpool0",{3,2,0},"max");
	ls.add_lrn("lrn0",5,0.0001,0.75);
	ls.add_conv("conv1",{64,1,1,0},1,"relu");
	ls.add_conv("conv2",{192,3,1,1},1,"relu");
	ls.add_lrn("lrn1",5,0.0001,0.75);
	ls.add_pool("maxpool1",{3,2,0},"max");
