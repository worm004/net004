...
class Parser{
	...
	void write_dat_data(Layer* layer, std::ofstream& ofile);
	void write_dat_conv(Layer* layer, std::ofstream& ofile);
	void write_dat_pool(Layer* layer, std::ofstream& ofile);
	void write_dat_activity(Layer* layer, std::ofstream& ofile);
